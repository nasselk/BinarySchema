...
export const FIXED_FIELDS_METHODS: Record<number, string> = {
	[FieldType.Int8]: "Int8",
...
export const FIXED_FIELDS_BITS: Record<number, number> = {
...
// min/max of its own.
export const FIXED_INTEGER_BOUNDS: Record<number, { min: number; max: number }> = {
